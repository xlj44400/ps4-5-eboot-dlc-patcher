...
def get_mount_handler_asm_bytes():
    ...
    # xor eax, eax
    # ret
    return bytes(b'\xC7\x02\x2F\x61\x70\x70\xC7\x42\x04\x30\x2F\x00\x00\x48\x8B\x06\x48\x89\x42\x06\x48\x8B\x46\x10\x48\x89\x42\x0E\x66\xC7\x42\x16\x2F\x00\x31\xC0\xC3')
...
if len(sceAppContentGetAddcontInfoList_patches) == 0:
    ida_kernwin.warning("No references to sceAppContentGetAddcontInfoList found, exiting...")
    exit()
